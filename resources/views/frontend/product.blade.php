                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product-details-tab">
                        <div class="pro-dec-big-img-slider">
                            ...
                            <div class="easyzoom-style">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="{{asset('assets/images/product-details/b-large-2.jpg')}}">
                                        <img src="{{asset('assets/images/product-details/large-2.jpg')}}" alt="">
                                    </a>
                                </div>
                                <a class="easyzoom-pop-up img-popup" href="{{asset('assets/images/product-details/b-large-2.jpg')}}"><i class="icon-size-fullscreen"></i></a>
                            </div>
                            <div class="easyzoom-style">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="{{asset('assets/images/product-details/b-large-3.jpg')}}">
                                        <img src="{{asset('assets/images/product-details/large-3.jpg')}}" alt="">
                                    </a>
                                </div>
                                <a class="easyzoom-pop-up img-popup" href="{{asset('assets/images/product-details/b-large-3.jpg')}}"><i class="icon-size-fullscreen"></i></a>
                            </div>
                            <div class="easyzoom-style">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="{{asset('assets/images/product-details/b-large-4.jpg')}}">
                    ...
                    <div class="single-product-wrap">
                        <div class="product-img product-img-zoom mb-15">
                            <a href="product-details.html">
                                <img src="{{asset('assets/images/product/product-19.jpg')}}" alt="">
                            </a>
                        ...
                        <div class="col-lg-5 col-md-6 col-12 col-sm-12">
                            ...
                            <div class="quickview-wrap mt-15">
                                <div class="quickview-slide-active nav-style-6">
                                    <a class="active" data-toggle="tab" href="#pro-1"><img src="{{asset('assets/images/product/quickview-s1.jpg')}}" alt=""></a>
                                    <a data-toggle="tab" href="#pro-2"><img src="{{asset('assets/images/product/quickview-s2.jpg')}}" alt=""></a>
                                    <a data-toggle="tab" href="#pro-3"><img src="{{asset('assets/images/product/quickview-s3.jpg')}}" alt=""></a>
                                    <a data-toggle="tab" href="#pro-4"><img src="{{asset('assets/images/product/quickview-s2.jpg')}}" alt=""></a>
                                </div>
                            </div>
                        </div>
